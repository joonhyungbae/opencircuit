...
`tekneh` 가 붙어 있으면 논문을 조회해서 열한 칸을 채울 수 있습니다.
이 코퍼스의 코딩 필드 열한 개가 위 열한 칸과 그대로 맞습니다.

```
@prompts/04-study-slides.md 10.1145/3757369.3767596 로 만들어줘
```

절차와 지켜야 할 규칙은 [prompts/04-study-slides.md](prompts/04-study-slides.md) 에 있습니다.
코퍼스는 **SIGGRAPH · SIGGRAPH Asia 아트 페이퍼 2009–2026, 작품 논문 229편**입니다.
그 밖의 논문(Ars Electronica · NIME · ISEA 등)은 직접 읽고 채웁니다.

초안이 나와도 **발표자가 직접 써야 하는 곳 셋**은 비워 둡니다 —
이 페이퍼를 고른 이유, ⑨ 의 한 문장, 토의 세 번째 항목.
